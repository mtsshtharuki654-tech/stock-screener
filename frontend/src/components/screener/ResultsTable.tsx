      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="w-full max-w-md px-8">
          ...
          <div className="w-full bg-gray-800 rounded-full h-3 mb-3 overflow-hidden">
            <div className="h-3 rounded-full bg-blue-500 transition-all duration-500" style={{ width: `${displayPct}%` }} />
          </div>
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      {isFromCache && (
        <div className="px-4 py-1.5 bg-yellow-900/40 border-b border-yellow-700/50 flex items-center gap-3 text-xs text-yellow-300">
          ...
          <button onClick={onClear} className="ml-auto px-2 py-0.5 rounded bg-yellow-700/50 hover:bg-yellow-600/60 text-yellow-200 text-xs">
            クリア
          </button>
        </div>
      )}
